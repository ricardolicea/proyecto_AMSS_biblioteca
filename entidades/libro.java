 ...
 * @author ricar
 */
public class libro extends autores{
    ...
    public libro(int idLibro, int topografico, String titulo, int iISBN,
     String tituloOriginal, String subtitulo, String edicion, String lugarPubli,
     int anoPubli, String notas, int numCopias, int costo, int numPaginas,
     String proveedor, Date adquisicion, boolean ilustraciones, boolean graficas,
     boolean mapas, boolean indices, boolean planas, boolean bibliografia,
     autores autor){
     ...
     public void agregar(int idLibro, int topografico, String titulo, int iISBN,
      String tituloOriginal, String subtitulo, String edicion, String lugarPubli,
      int anoPubli, String notas, int numCopias, int costo, int numPaginas,
      String proveedor, Date adquisicion, boolean ilustraciones, boolean graficas,
      boolean mapas, boolean indices, boolean planas, boolean bibliografia,
      autores autor){
        try {
           String query = "INSERT INTO libro (idLibro, topografico, titulo, nombre) VALUES (?, ?, ?, ?)";
